...
const Health = (() => {
  ...
  function render(){
    ...
    q('#health-source').textContent=page==='workouts'?'Recorded locally on this phone':page==='sleep'?'Demo night · stage timing illustration':'Demo data · '+stamp(options.getDate()+'T12:00:00',true);
