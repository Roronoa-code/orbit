...
Current build: `android/build/20260911-030125`; APK SHA256 `5076c44e3a93f0442e5f756f13354ec3571d5fe793d16985b954442c7a51d722`. It contains the five fixes of 11 September (launcher swipe-down, Body icon, launcher name, first-swipe smoothness, small music player on the workout view) and was installed on the Galaxy SM-S938B at the user's request on 11 September 03:09 (data kept, installed hash matched, not launched; record `verification/five-fixes-install.json`). The previous phone build `5eec8e21feee715220995be14b76c16ba003a4e572677a01ce944be8c20503dc` (music switching fix plus the performance pass) is backed up at `verification/five-fixes-phone/phone-before.apk`. Current evidence: `verification/five-fixes-result.json`, `verification/perf-result.json` and `HANDOFF.md`.
