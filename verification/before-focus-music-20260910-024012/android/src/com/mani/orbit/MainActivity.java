...
public final class MainActivity extends Activity {
    ...
    @Override protected void onResume() { super.onResume(); if (web != null) { web.onResume(); if (pageReady) web.evaluateJavascript("Health.refresh();",null); } if (workouts != null) workouts.updateNotification(); enterImmersive(); }
