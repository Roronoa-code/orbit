...
const SurfaceMotion=(()=>{
  ...
  document.addEventListener('visibilitychange',()=>{if(document.hidden)settle()});reduced.addEventListener('change',()=>{if(reduced.matches)settle()});window.addEventListener('resize',settle);
