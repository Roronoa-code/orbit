...
console.log('PASS: 4 metrics × 30 dates × 3 periods; coherent totals; 646 Signal particles; horizontal swipe and keyboard metric cycle; vertical swipe guard; one animation loop; pause/reduced-motion/hidden/offscreen stop; live summaries; stack expand/collapse; embedded font.');
