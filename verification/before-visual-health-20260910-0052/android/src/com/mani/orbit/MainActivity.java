...
public final class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle state) {
        ...
        web.addJavascriptInterface(new WorkoutStorage(getSharedPreferences("orbit-workouts", MODE_PRIVATE)), "OrbitWorkouts");
    ...
    public static final class WorkoutStorage {
        private final SharedPreferences preferences;
        WorkoutStorage(SharedPreferences preferences) { this.preferences = preferences; }
        @JavascriptInterface public synchronized String read() { return preferences.getString("sessions", null); }
        @JavascriptInterface public synchronized boolean write(String value) {
            ...
            try {
                ...
                if (!data.has("active") || (!data.isNull("active") && !(data.get("active") instanceof JSONObject))) return false;
                data.getJSONArray("history");
                return preferences.edit().putString("sessions", value).commit();
