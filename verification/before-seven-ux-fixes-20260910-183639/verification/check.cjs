...
const wideClock=dots.mount(dotCanvas,'24:59:59',true);advanceDots(1800);assert(dotsDrawn.length>100&&dotsDrawn.every(([x,y])=>x>0&&x<390&&y>0&&y<116),'A long focused clock must fit the wide canvas');wideClock.stop();
