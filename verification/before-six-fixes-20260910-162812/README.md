...
Latest evidence and hashes: `verification/focus-music-launcher-result.json`. Earlier hero/sleep evidence remains in `verification/hero-sleep-frost-result.json`. The current recoverable baseline is `verification/before-focus-music-20260910-024012/`, with the later `before-flat-launcher-20260910-025030.html` checkpoint. These contain sources being changed and the previous APK, not dependency trees.
