...
public final class MainActivity extends Activity {
    ...
    private void goBack() {
        web.evaluateJavascript("(() => {const d=document.querySelector('dialog[open]');if(d){d.close();return true;}const b=document.querySelector('#back');if(b&&!b.disabled){b.click();return true;}return false;})()",
