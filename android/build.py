...
inline('<link rel="stylesheet" href="health-dashboard.css">', 'health-dashboard.css')
for name in ['health-data.js', 'health-dashboard.js', 'settings-store.js', 'surface-motion.js', 'orbit-interaction.js', 'hero-dots.js', 'sleep-timeline.js', 'blob-track.js', 'liquid-glass.js', 'glass-response.js', 'workout-focus.js', 'workout-details.js', 'orbit-settings.js', 'signal-orb.js']:
