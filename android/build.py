...
for name in ['settings-store.js', 'surface-motion.js', 'orbit-interaction.js', 'hero-dots.js', 'sleep-timeline.js', 'blob-track.js', 'liquid-glass.js', 'workout-focus.js', 'workout-details.js', 'orbit-settings.js', 'signal-orb.js']:
